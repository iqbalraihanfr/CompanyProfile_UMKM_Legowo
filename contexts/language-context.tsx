...
const translations = {
    en: {
        ...
        featuressec: {
            ...
            words: "We provide high-quality educational and decorative products to support children's learning and development, while also offering creative and functional solutions for your business.",
            cardtitle1: "Trusted Experience",
            cardwords1: "Established in 2013, we’ve built a solid reputation for over a decade in the educational toy industry.",
            cardtitle2: "High Educational Value",
            cardwords2: "Our toys are designed to stimulate children's cognitive, motor, and social-emotional development.",
            cardtitle3: "Premium Materials",
            cardwords3: "We use only high-quality wood to ensure product durability and safety.",
            cardtitle4: "Continuous Innovation",
            cardwords4: "We continuously develop new designs to meet the evolving educational needs of children.",
            cardtitle5: "Local Product, Global Quality",
            cardwords5: "Proudly made in Indonesia, crafted with international quality standards.",
            cardtitle6: "Excellent Customer Service",
            cardwords6: "We are committed to providing a satisfying shopping experience and reliable after-sales support.",
    ...
    id: {
        ...
        featuressec: {
            ...
            cardtitle1: "Pengalaman Terpercaya",
            cardwords1: "Berdiri sejak 2013, kami telah membangun reputasi solid selama lebih dari satu dekade dalam industri mainan edukatif.",
            cardtitle2: "Nilai Edukatif Tinggi",
            cardwords2: "Mainan kami dirancang untuk merangsang perkembangan kognitif, motorik, dan sosial emosional anak.",
            cardtitle3: "Bahan Berkualitas",
            cardwords3: "Kami hanya menggunakan kayu berkualitas tinggi untuk menjamin daya tahan dan keamanan produk.",
            cardtitle4: "Inovasi Berkelanjutan",
            cardwords4: " Kami terus mengembangkan desain baru untuk memenuhi kebutuhan pendidikan anak yang selalu berkembang.",
            cardtitle5: " Produk Lokal Berkualitas Global:",
            cardwords5: "Diproduksi di Indonesia dengan standar kualitas internasional.",
            cardtitle6: "Layanan Pelanggan Prima",
            cardwords6: "Kami berkomitmen untuk memberikan pengalaman berbelanja yang memuaskan dan dukungan pasca pembelian.",
        },
        aboutsec: {
